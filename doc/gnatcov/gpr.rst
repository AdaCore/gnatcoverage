...
Please note that **non-library aggregate project files with more than one
aggregated project are currently not supported** and will be rejected by |gcv|.
The aggregated projects will have to be processed individually and coverage
reports consolidated :ref:`through checkpoints<checkpoints>`, when this makes
sense.
...
``External_Annotations`` attribute designating the external annotation file of
that project. See :ref:`ext_annot_attribute`.
