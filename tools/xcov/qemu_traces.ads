...
package Qemu_Traces is
   ...
   --  Contains the executable filename.
   Info_Kind_Exec_Filename : constant Unsigned_32 := 1;

   --  Contains switches used to do coverage.
   --  No formal definition as the tool that writes this data will also read
   --  it.
   Info_Kind_Coverage_Options : constant Unsigned_32 := 2;
