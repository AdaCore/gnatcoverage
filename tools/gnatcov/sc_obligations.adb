...
package body SC_Obligations is
      ...
      for Cur in Added_PP_Info.Iterate loop
         ...
         begin
            if not Real_PP_Info.Contains (SCO) then
               ...
               Remap_SFI
                 (Relocs, CP_SFI => Info.Actual_Source_Range.Source_File);
   ...
   is
      ...
      procedure Warn (Sloc : Source_Location; Message : String) is
      begin
         if not Silent then
            Report (Sloc, Message, Warning);
         end if;
