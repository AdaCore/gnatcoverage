   ...
   Command_Infos : constant Command_Info_Array :=
     (Cmd_Help                        =>
        Create
          (Name        => "--help",
           Description =>
             ("Display help for command line commands and" & " arguments."),
           Internal    => False),
      Cmd_Help_Internal               =>
        Create
          (Name        => "--help-internal",
           Description =>
             ("Display help for internal command line commands and"
              & "arguments."),
           Internal    => True),
      Cmd_Version                     =>
        Create
      ...
      Cmd_Convert                     =>
        Create
          (Name        => "convert",
           Pattern     =>
             ("[OPTIONS] --trace-source=SOURCE_ID --exec=EXECUTABLE"
              & " --input=INPUT_TRACE"),
           Description =>
             ("Convert vendor-specific trace files into"
      ...
      Cmd_Extract_Base64_Trace        =>
        Create
          (Name        => "extract-base64-trace",
           ...
           Description =>
             ("Extract a trace file from a log file that contains"
      ...
      Cmd_Scan_Decisions              =>
        Create
          (Name        => "scan-decisions",
           ...
           Description =>
             ("Scan source coverage obligations for multiple paths"
              & " decisions."),
           Internal    => False),
      ...
      Cmd_Dump_Trace_Asm              =>
        Create
          (Name        => "dump-trace-asm",
           ...
           Description =>
             ("Display of trace files with assembly code for each"
              & " trace."),
           Internal    => True),
      Cmd_Dump_Src_Trace              =>
        Create
          (Name        => "dump-src-trace",
           Pattern     => "[TRACE_FILEs]",
           Description =>
             "Dump the content of a source trace file in a human"
             & "-readable text form.",
           Internal    => True),
      Cmd_Dump_Sections               =>
        Create
      ...
      Cmd_Dump_Compile_Units          =>
        Create
          (Name        => "dump-compile-units",
           Pattern     => "[EXEs]",
           Description =>
             ("Dump the name of DW_TAG_compile_unit from the"
      ...
      Cmd_Dump_Lines                  =>
        Create
          (Name        => "dump-lines",
           Pattern     => "[EXEs]",
           Description =>
             "Dump source line information from executable files.",
           Internal    => True),
      Cmd_Dump_CFG                    =>
        Create
          (Name        => "dump-cfg",
      ...
      Cmd_Disassemble_Insn_Properties =>
        Create
          (Name        => "disassemble-insn-properties",
           ...
           Description =>
             ("Disassemble instructions in the executable matching"
      ...
      Cmd_Scan_Objects                =>
        Create
          (Name        => "scan-objects",
           Pattern     => "[FILEs]",
           Description =>
             ("Scan object FILEs for empty symbols or orphan" & " regions."),
           Internal    => True),
      Cmd_Setup                       =>
        Create
          (Name        => "setup",
           Description =>
             "Build and install the runtime for source"
      ...
      Cmd_Instrument_Project          =>
        Create
          (Name        => "instrument",
           Description =>
             ("Instrument the given project and produce the"
      ...
      Cmd_Instrument_Source           =>
        Create
          (Name        => "instrument-source",
           Description =>
             "Instrument the given files, all belonging to the"
             & " same unit.",
           Pattern     => "[FILES]",
           Internal    => True),
      Cmd_Instrument_Main             =>
        ...
        Create
          (Name        => "setup-integration",
           Description =>
             ...
             & " through the --files switch, the compiler driver in used"
             & " through the --compilers switch, and the configuration and"
             & " compiler driver wrappers are generated in the subdirectory"
      ...
      Cmd_Gcc_Wrapper                 =>
        Create
          (Name        => "gcc-wrapper",
           Description =>
             "Implementation of the GCC wrapper for integrated"
             & " instrumentation.",
        ...
        Create
          (Name        => "add-annotation",
           Description =>
             ...
             & " analysis. All annotations passed through"
             & " --external-annotations are consolidated and written to"
             & " OUTPUT_FILENAME."
             & ASCII.LF
             & ASCII.LF
      ...
      Cmd_Delete_Annotation           =>
        Create
          (Name        => "delete-annotation",
           Description =>
             "Delete the annotation with identifier IDENTIFIER from those"
             & " stored in EXT_FILENAMEs, and write back the remaining"
             & " annotations to OUTPUT_FILENAME.",
           Pattern     =>
     ...
     (Opt_Verbose                      =>
      ...
      Opt_Recursive                    =>
        Create
          (Long_Name => "--recursive",
           Help      =>
             "DEPRECATED: In addition to those designated by"
             & " -P/--projects, consider units from any"
             & " transitively imported project.",
           Commands  =>
             (Cmd_Run | Cmd_Coverage | Cmd_Instrument_Project | Cmd_Dump_CFG =>
                True,
              others                                                         =>
                False),
           Internal  => False),
      Opt_No_Subprojects               =>
        Create
          (Long_Name => "--no-subprojects",
           Help      =>
             "Consider only units designated by the project"
      ...
      Opt_All_Messages                 =>
        Create
          (Long_Name => "--all-messages",
           Help      =>
             "When performing source coverage analysis, also include"
      ...
      Opt_Include                      =>
        Create
          (Long_Name => "--include",
           Help      =>
             "Include the symbols from the next object file on"
      ...
      Opt_Exclude                      =>
        Create
          (Long_Name => "--exclude",
           Help      =>
             "Exclude the symbols from the next object file on"
             & " the command line to the list of routines",
           Commands  => (Cmd_Disp_Routines => True, others => False),
           Internal  => False),
      Opt_Excluded_SCOs                =>
        Create
          (Long_Name => "--non-coverable",
           Help      =>
             "Report SCOs whose coverage cannot be established due to"
      ...
      Opt_Keep_Edges                   =>
        Create
          (Short_Name => "-k",
           Help       =>
             "Do not strip edges that are supposed to be uncoverable"
             & " due to exceptions.",
      ...
      Opt_Keep_Reading_Traces          =>
        Create
          (Long_Name => "--keep-reading-traces",
           Help      =>
             "When an error occurs while reading a trace file,"
      ...
      Opt_Externally_Built_Projects    =>
        Create
          (Long_Name => "--externally-built-projects",
           Help      =>
             "Look into projects marked as externally built when"
           ...
           Commands  =>
             (Cmd_Run | Cmd_Instrument | Cmd_Coverage | Cmd_Dump_CFG => True,
              others                                                 => False),
           Internal  => False),
      ...
      Opt_Show_MCDC_Vectors            =>
        Create
          (Long_Name => "--show-mcdc-vectors",
           Help      =>
             "DEPRECATED: If set, show MCDC evaluation vectors"
      ...
      Opt_Allow_Mix_Trace_Kind         =>
        Create
          (Long_Name => "--mix-trace-kind",
           Help      =>
             "Allow mixing binary and source traces. A warning will"
             & " still be emitted.",
           Commands  => (Cmd_Coverage => True, others => False),
           Internal  => True),
      ...
      Opt_Cancel_Annotate              =>
        Create
          (Long_Name => "--cancel-annotate",
           Help      =>
             "Prevent gnatcov from generating a coverage report if"
        ...
        Create
          (Long_Name => "--no-stdlib",
           Help      =>
             ...
             & " function for the coverage runtime must be provided by the"
      ...
      Opt_Report_Title           =>
        Create
          (Long_Name    => "--report-title",
           Pattern      => "TITLE LABEL",
           Help         =>
             "Override the default title for HTML coverage" & " reports.",
           Commands     => (Cmd_Coverage => True, others => False),
           At_Most_Once => False,
           Internal     => False),
      ...
      Opt_Dump_Channel           =>
        Create
          (Long_Name    => "--dump-channel",
           Help         =>
             "Select a channel to dump coverage buffers in the"
      ...
      Opt_Dump_Filename_Env_Var  =>
        Create
          (Long_Name    => "--dump-filename-env-var",
           Help         =>
             "Valid only when --dump-channel=bin-file. Name of the"
      ...
      Opt_Dump_Filename_Prefix   =>
        Create
          (Long_Name    => "--dump-filename-prefix",
           Help         =>
             "Valid only when --dump-channel=bin-file. Select a"
      ...
      Opt_Ada                    =>
        Create
          (Long_Name    => "--ada",
           ...
           Help         =>
             "Select a target language version for source"
      ...
      Opt_Timezone               =>
        Create
          (Long_Name    => "--timezone",
           Pattern      => "local|utc",
           Help         =>
             "State the reference timezone to use when displaying"
        ...
        Create
          (Long_Name    => "--rts-profile",
           ...
           Help         =>
             ...
             & ASCII.LF
             & ASCII.LF
             & """full"" allows the instrumentation runtime to use all"
             & " features from a standard C runtime: read environment"
             & " variables, open files, get the current time, ..."
             & ASCII.LF
             & ASCII.LF
             ...
             & ASCII.LF
             & ASCII.LF
             & """auto"" lets gnatcov automatically choose between ""full"""
             & " and ""embedded"" depending on the selected target and RTS.",
           Commands     => (Cmd_Setup => True, others => False),
           At_Most_Once => False,
           Internal     => True),
        ...
        Create
          (Long_Name    => "--install-name",
           ...
           Help         =>
             ...
             & " ""gnatcov_rts"", or the name on the project passed to"
             & " ""gnatcov setup"". Using non-default names allows one to"
             & " install different projects in the same installation prefix.",
           Commands     =>
             (Cmd_Setup | Cmd_Instrument => True, others => False),
           At_Most_Once => False,
           Internal     => False),
        ...
        Create
          (Long_Name    => "--runtime-project",
           ...
           Help         =>
             ...
             & " ""gnatcov setup""'s ""--install-name"" option). By default,"
             & " use ""gnatcov_rts"".",
           Commands     =>
             (Cmd_Instrument_With_Setup => True, others => False),
           At_Most_Once => False,
           Internal     => False),
      ...
      Opt_Annotation_Kind        =>
        Create
          (Long_Name    => "--kind",
           ...
           Commands     =>
             (Cmd_Add_Annotation | Cmd_Delete_Annotation | Cmd_Show_Annotations
              => True,
              others
              => False),
           At_Most_Once => False,
      ...
      Opt_End_Location           =>
        Create
          (Long_Name    => "--end-location",
           Pattern      => "LINE:COL",
           Help         =>
             "Location of the end of the range to which the annotation"
             & " applies. LINE and COL should be positive integers.",
           Commands     => (Cmd_Add_Annotation => True, others => False),
           At_Most_Once => False,
           Internal     => False),
        ...
        Create
          (Long_Name => "--sid",
           ...
           Help      =>
             ...
             & " LISTFILE.",
           Commands  =>
             (Cmd_Coverage | Cmd_Instrument_Source => True, others => False),
           Internal  => False),
      Opt_Routines                =>
        Create
          (Long_Name => "--routines",
           ...
           Commands  =>
             (Cmd_Run | Cmd_Coverage | Cmd_Scan_Decisions | Cmd_Map_Routines =>
                True,
              others                                                         =>
                False),
           Internal  => False),
        ...
        Create
          (Long_Name               => "--restricted-to-languages",
           ...
           Help                    =>
             ...
             & " still be instrumented to dump the coverage state to trace"
             & " files.",
           Commands                =>
             (Cmd_Setup | Cmd_Instrument_Project | Cmd_Coverage => True,
              others                                            => False),
           Internal                => False,
           Accepts_Comma_Separator => True),
      Opt_Annotation_Format       =>
        Create
          (Long_Name               => "--annotate",
           ...
           Help                    =>
             ...
             & ASCII.LF
             & "Multiple reports can be produced in a single"
