...
package SC_Obligations is
   ...
   type PP_Info is record
      ...
      --  preprocessed) view of the source file.
   ...
   package SCO_PP_Info_Maps is new
     Ada.Containers.Ordered_Maps (Key_Type => SCO_Id, Element_Type => PP_Info);
   ...
   --  Return whether the given SCO has macro expansion information

   function Has_Include_Info (SCO : SCO_Id) return Boolean;
   --  Return whether the given SCO has inclusion expansion information
   ...
   --  Return the inclusion expansion information (if any) for the given SCO
   ...
   type Pragma_Id is
     (Pragma_Abort_Defer,
      ...
      Pragma_Debug,
      Pragma_Debug_Policy,
      Pragma_Default_Dispatching_Calls,
   ...
   Pragma_Might_Generate_Code : constant array (Pragma_Id) of Boolean :=
     ( --  Configuration pragmas
      ...
      Pragma_Default_Dispatching_Calls      => False,
