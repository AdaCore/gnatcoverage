...
Which achieves object branch coverage, as |gcp| correctly reports::
...
Note --scos and --level passed to |gcvrun| for mcdc analysis purposes::

  gnatcov run --scos=@alis --level=stmt+mcdc obj/test_orand

Mention paper a tech report.
