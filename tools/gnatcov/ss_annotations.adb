...
package body SS_Annotations is
   ...
   is
      ...
      begin
         if Kind in Exempt_On | Exempt_Decision_Outcome then
            case Kind is
               when Exempt_On               =>
   ...
   begin
      ...
      case Annot_Kind is
         when Exempt_On | Exempt_Region | Exempt_Decision_Outcome | Cov_Off =>
      ...
      for I in 1 .. Entr.Annotations.Length loop
         ...
         begin
            case Annot_Kind is
               ...
               when Exempt_On | Exempt_Region | Exempt_Decision_Outcome =>
                  Some_Relevant := True;
