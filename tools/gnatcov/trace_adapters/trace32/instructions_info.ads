...
package Instructions_Info is
   ...
   procedure Load_Elf (This : in out Insn_Info; Exec_Path : String);
   ...
   with Pre => Loaded (This) and then Kind (This, PC) /= Unknown;
   ...
   function Fallthrough_Address
     (This : in out Insn_Info; Caller, Target : Pc_Type) return Boolean
   with Pre => Loaded (This) and then Kind (This, Caller) = Branch;
