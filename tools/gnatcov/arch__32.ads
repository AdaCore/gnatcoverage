...
package Arch is
   ...
   procedure Elf_Ehdr_Swap (Ehdr : in out Elf_Ehdr) renames Elf32_Ehdr_Swap;
   procedure Elf_Shdr_Swap (Shdr : in out Elf_Shdr) renames Elf32_Shdr_Swap;
   procedure Elf_Chdr_Swap (Chdr : in out Elf_Chdr) renames Elf32_Chdr_Swap;
   procedure Elf_Rela_Swap (Rela : in out Elf_Rela) renames Elf32_Rela_Swap;
   procedure Elf_Sym_Swap (Sym : in out Elf_Sym) renames Elf32_Sym_Swap;

   function Elf_R_Sym (I : Elf_Word) return Elf_Word renames Elf32_R_Sym;
   function Elf_R_Type (I : Elf_Word) return Elf_Word renames Elf32_R_Type;
   function Elf_R_Info (S, T : Elf_Word) return Elf_Word renames Elf32_R_Info;
