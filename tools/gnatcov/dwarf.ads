...
package Dwarf is
   ...
   DW_OP_addr                : constant :=
     16#03#; -- 1 constant address (target spec)
   ...
   DW_OP_breg31              : constant :=
     16#8f#; -- 1 SLEB128 offset base reg 0..31
   DW_OP_regx                : constant := 16#90#; -- 1 ULEB128 register
   DW_OP_fbreg               : constant := 16#91#; -- 1 SLEB128 offset
   DW_OP_bregx               : constant :=
     16#92#; -- 2 ULEB128 reg + SLEB128 offset
   DW_OP_piece               : constant :=
     16#93#; -- 1 ULEB128 size of piece addressed
   DW_OP_deref_size          : constant :=
     16#94#; -- 1 1-byte size of data retrieved
   DW_OP_xderef_size         : constant :=
     16#95#; -- 1 1-byte size of data retrieved
   ...
   DW_OP_call_ref            : constant :=
     16#9a#; -- 1 4- or 8-byte offset of DIE
   ...
   DW_OP_addrx               : constant :=
     16#a1#; -- 1 ULEB128 indirect address
   DW_OP_constx              : constant :=
     16#a2#; -- 1 ULEB128 indiret constant
   DW_OP_entry_value         : constant := 16#a3#; -- 2 ULEB128 size + block
   DW_OP_const_type          : constant :=
     16#a4#; -- 3 ULEB128 off +size + value
