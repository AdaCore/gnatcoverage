...
* Build and install the coverage runtime in a dedicated <GNATCOV_RTS_DIR>
  ...
  *Operational Environment* section of the |tor_doc| document for this,
  ...
  Environment* described in the |tor_doc| document has not changed as of
...
* Instrument the application for coverage assessment and test harness main
  ...
  *Operational Environment* section of the |tor_doc| document. Also specify the
...
* Build the application and test executables with the GNAT Pro toolchain
  identified in the *Operational Environment* section of the |tor_doc| document,
...
* <DUMP_TRIGGER> identifies the trigger to produce execution traces, as
  ...
  is defined in the |tor_doc| document;
* <DUMP_CHANNEL> identifies the medium used by the instrumented executable to
  ...
  which the value to be used is defined in the |tor_doc| document;
