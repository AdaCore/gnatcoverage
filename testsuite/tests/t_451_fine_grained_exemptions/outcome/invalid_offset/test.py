...
warnings = [
    ...
    "*** pkg.adb:11:7: warning: Could not find a decision before the end of"
    " the next statement (at 15:25) after skipping 2 decisions while"
    " processing exemption annotation",
    "*** pkg.adb:17:7: warning: Could not find a decision while processing"
