...
from SUITE.tutils import (
    exepath_to, gprbuild, gprfor, thistest, tracename_for, xcov, xrun
)
...
gpr_stage1 = gprfor(
    'foo.c', prjid='stage1', srcdirs='..', exedir='.',
    main_cargs='-g0 -save-temps', langs=('C', ))
gprbuild(gpr_stage1, gargs='-c', **_cargs)

# Second stage: assemble to object code with debug information relative to the
# assembly.
gpr_stage2 = gprfor(
    'foo.s', prjid='stage2', srcdirs='obj', exedir='.',
    main_cargs='-g', langs=('Asm', ))
