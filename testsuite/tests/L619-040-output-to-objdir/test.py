...
xcov_args = build_and_run(
    gprsw=GPRswitches(root_project=gprfor(mains=['pgm.adb'], srcdirs=['..'],
                                          objdir='obj', exedir='obj')),
    gpr_obj_dir='obj',
    covlevel='stmt',
    mains=['pgm'],
    gpr_exe_dir='obj',
...
thistest.fail_if(not os.path.exists('obj/pgm.adb.xcov'),
...
thistest.fail_if(not os.path.exists('pgm.adb.xcov'),
