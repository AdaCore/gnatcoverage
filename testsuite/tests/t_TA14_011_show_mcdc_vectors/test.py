...
def check_output(
    ...
    :param output_file: Name of the text file whose content needs to be
        checked.
    :param expected_content: Expected content for this file.
    :param regexp: Whether to match as a regexp (by default, check content
        equality).
    """
    checker = (
