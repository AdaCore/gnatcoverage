...
package GCVRT.Bz5596b68b is
   ...
   package Buffers_1 is
      ...
      pragma Export
        (C, Statement_Buffer_Address, "xcov__buf_stmt__zed93bb71_1");
      ...
      pragma Export
        (C, Decision_Buffer_Address, "xcov__buf_dc__zed93bb71_1");

      MCDC_Buffer : Coverage_Buffer_Type (0 .. -1) :=
        (others => False);
      MCDC_Buffer_Address : constant System.Address := MCDC_Buffer'Address;
      pragma Export
        (C, MCDC_Buffer_Address, "xcov__buf_mcdc__zed93bb71_1");

      Filename : constant String := "C:\tmp\t_U204_026_arch_mix\main_1.adb";
...
1 => Buffers_1.Buffers'Access
   ...
   pragma Export (C, C_Buffers_Group, "gnatcov_rts_buffers_z5596b68b_buffers");

end GCVRT.Bz5596b68b;
