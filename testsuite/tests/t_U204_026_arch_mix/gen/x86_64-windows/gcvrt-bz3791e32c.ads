...
package GCVRT.Bz3791e32c is
   ...
   package Buffers_1 is
      ...
      pragma Export
        (C, Statement_Buffer_Address, "xcov__buf_stmt__zce2465f9_1");
      ...
      pragma Export
        (C, Decision_Buffer_Address, "xcov__buf_dc__zce2465f9_1");

      MCDC_Buffer : Coverage_Buffer_Type (0 .. -1) :=
        (others => False);
      MCDC_Buffer_Address : constant System.Address := MCDC_Buffer'Address;
      pragma Export
        (C, MCDC_Buffer_Address, "xcov__buf_mcdc__zce2465f9_1");

      Filename : constant String := "C:\tmp\t_U204_026_arch_mix\pkg.ads";
   ...
   package Buffers_2 is
      ...
      Statement_Buffer_Address : constant System.Address :=
         Statement_Buffer'Address;
      pragma Export
        (C, Statement_Buffer_Address, "xcov__buf_stmt__zce2465e8_2");
      ...
      Decision_Buffer_Address : constant System.Address :=
         Decision_Buffer'Address;
      pragma Export
        (C, Decision_Buffer_Address, "xcov__buf_dc__zce2465e8_2");

      MCDC_Buffer : Coverage_Buffer_Type (0 .. 2) :=
        (others => False);
      MCDC_Buffer_Address : constant System.Address := MCDC_Buffer'Address;
      pragma Export
        (C, MCDC_Buffer_Address, "xcov__buf_mcdc__zce2465e8_2");

      Filename : constant String := "C:\tmp\t_U204_026_arch_mix\pkg.adb";
