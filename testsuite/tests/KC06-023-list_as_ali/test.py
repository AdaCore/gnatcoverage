...
# Expect failure
p = xcov(['map-routines', '--scos=../plist', 'obj/p.o'],
         out='list_as_ali.out', register_failure=False)
thistest.fail_if(p.status == 0 or
                 not match('malformed ALI file', 'list_as_ali.out'),
