--  This package contains library-level constant array object declaration with
--  explicit initialization expression and subprograms containing local
--  constant array object declarations with explicit initializations that are
...
package Decls_Pack is
   ...
   Matrix_C : constant Matrix := ((1, 2), (3, Identity (4))); -- # dcls
